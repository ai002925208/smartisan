<template>
  <div id="main">
    <div class="sku-box store-content">
      ...
      <div class="gray-box">
        <div class="item-box">
          <my-items v-for="item in data" :key="item.id" :item="item"></my-items>
        </div>
      </div>
    </div>
  </div>
...
<script>
    import data from '../lib/newGoodsData.js';
...
<style>
  ...
  .sku-box .item .item-btns .item-blue-btn:hover{
    ...
    /*background-color: ;*/
    background: #5074db linear-gradient(#6e8ed5,#4769c2);
  }
  .sku-box .item .item-btns .item-blue-btn:active{
    border: 1px solid #3e61d7;
    background: #5c85e5 linear-gradient(#4d72de,#6189e6);
  }
