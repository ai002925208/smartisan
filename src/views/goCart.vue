        ...
        <div class="store-content">
            <div class="cart-box">
                ...
                <div class="cart-inner">
                    <div
                        class="empty-label"
                        :class="{'hide':$store.state.cartList.length}">
                        <h3>您的购物车中还没有商品</h3>
                        <router-link
                            to="/"
                            class="link"
                ...
                <div
                    class="cart-bottom-bg fix-bottom"
                    v-show="$store.state.cartList.length">
                    ...
                    <div class="shipping">
                        ...
                        <span
                            ...
                            :class="{'disabled-btn':!checkedData.length}"><router-link :to="{name:'checkout'}">现在结算</router-link></span>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    export default {
        ...
        computed:{
            ...
            //已选择数量
            checked(){
                return this.checkedData.reduce((sum,now)=>sum+now.count,0);
            },
            // 总计件数
            sumNum(){
        ...
        methods:{
            ...
            addFn(itm){
                // console.log(itm);
                this.$store.commit('addFn',itm)
            },
            //点击减少商品
            plusFn(itm){
                // console.log(itm);
                this.$store.commit('plusFn',itm)
            },
            //点击删除
            delFn(i){
...
<style scoped>
    ...
    .gray-box .cart-bottom-bg{
        /*height: 80px;
          background: url(../asset/img/store/library/cart-wrapper-bg.jpg) repeat-x;
